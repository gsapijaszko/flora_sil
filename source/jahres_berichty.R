...
jahres <- data.frame(
  ...
  lon = 16.29477, 
  lat = 50.73411, 
  comments = "https://de.wikipedia.org/wiki/Czettritz; https://bibliothek.alpenverein.de/webOPAC/02_AV-Sektionsschriften/Sektion_Waldenburg/Jahresberichte/SektionWaldenburg1908Nr.2-web.pdf"
) |> rbind(jahres)
...
jahres <- data.frame(
  ...
  lon = 18.33008,   
  lat = 50.36337, 
  comments = "http://maps.mapywig.org/m/German_maps/series/025K_TK25/5675_Kandrzin_1884.jpg"
) |> rbind(jahres) 
...
jahres <- data.frame(
  ...
  #' Aspidium montanum (Vogler) Aschs. -- der 1893 angegebene Fund­ ort bei Burghammer ist irrthümlich, es muss heissen „Jungfernteich bei Wartha südlich von Lohsa“ (Barber).; [@fiekErgebnisseDurchforschungSchlesischen1895] 
  lon = 14.57456, 
  lat = 51.26790, 
  comments = ""
) |> rbind(jahres)
